...
export const SRD_WEAPONS: Weapon[] = [
  ...
  { id: 'wpn-glaive', name: 'Glaive', damage: '1d10', damageType: 'slashing', properties: ['twoHanded', 'heavy'], category: 'martial', reach: 10, mastery: 'graze' },
  ...
  { id: 'wpn-halberd', name: 'Halberd', damage: '1d10', damageType: 'slashing', properties: ['twoHanded', 'heavy'], category: 'martial', reach: 10, mastery: 'cleave' },
  { id: 'wpn-lance', name: 'Lance', damage: '1d10', versatileDamage: '1d12', damageType: 'piercing', properties: ['versatile', 'heavy'], category: 'martial', reach: 10, mastery: 'topple' },
  ...
  { id: 'wpn-pike', name: 'Pike', damage: '1d10', damageType: 'piercing', properties: ['twoHanded', 'heavy'], category: 'martial', reach: 10, mastery: 'push' },
  ...
  { id: 'wpn-trident', name: 'Trident', damage: '1d8', versatileDamage: '1d10', damageType: 'piercing', properties: ['versatile', 'thrown'], category: 'martial', range: 20, longRange: 60, mastery: 'topple' },
  ...
  { id: 'wpn-whip', name: 'Whip', damage: '1d4', damageType: 'slashing', properties: ['finesse'], category: 'martial', reach: 10, mastery: 'slow' },
  ...
  { id: 'wpn-net', name: 'Net', damage: '0', damageType: 'bludgeoning', properties: ['thrown'], category: 'martial', range: 15 },
